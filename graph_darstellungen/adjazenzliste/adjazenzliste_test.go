...
// Tests für die Implementierung der Adjazenzliste als Graph-Darstellung.
//
// Anmerkungen:
// - Der Datentyp `AdjacencyListGraph` implementiert das Interface `Graph`
...
func TestGetEdges(t *testing.T) {
	...
	edges = g2.GetEdges()
	expected := [][3]int{{0, 1, 5}, {0, 2, 3}, {1, 2, 1}}
	graph.AssertEdgesEqual(edges, expected, t)
}

func TestAddEdge(t *testing.T) {
	graph.CheckAddEdge(EmptyAdjacencyListGraph, t)
}

func TestRemoveEdge(t *testing.T) {
	graph.CheckRemoveEdge(EmptyAdjacencyListGraph, t)
}

func TestGetNeighbors(t *testing.T) {
	graph.CheckGetNeighbors(EmptyAdjacencyListGraph, t)
}

func TestDegree(t *testing.T) {
	graph.CheckDegree(EmptyAdjacencyListGraph, t)
}

func TestHasEdge(t *testing.T) {
	graph.CheckHasEdge(EmptyAdjacencyListGraph, t)
}

func TestGetEdgeWeight(t *testing.T) {
	graph.CheckGetEdgeWeight(EmptyAdjacencyListGraph, t)
}

func TestDotString(t *testing.T) {
	graph.CheckDotString(EmptyAdjacencyListGraph, t)
}
